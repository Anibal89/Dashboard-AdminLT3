...
import Touka from '../Img/Touka.gif';
    ...
    <div className="row mb-2">
      ...
      <div className="col-sm-6">
        <ol className="breadcrumb float-sm-right">
          ...
          <li className="breadcrumb-item active">Imagenes</li>
        </ol>
      </div>
    </div>
  </div>{/* /.container-fluid */}
      ...
      <div className="col-12">
        <div className="card card-dark">
          <div className="card-header">
            <h4 className="card-title">Lista de imagenes</h4>
          </div>
          <div className="card-body">
            <div className="row">
              <div className="col-sm-2">
                <img src="https://via.placeholder.com/300/000000?text=1" className="img-fluid mb-2" alt="black sample" /> 
              </div>
              <div className="col-sm-2">
